...
import { Globe, ArrowLeft, Lock, User, ArrowRight, Shield, Bell, AlertCircle, Info, TrendingUp } from "lucide-react";
        ...
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block">
            ...
            <p className="text-lg text-slate-400 leading-relaxed mb-8">
              Manage inventory, track shipments, and collaborate with your team.
            </p>
